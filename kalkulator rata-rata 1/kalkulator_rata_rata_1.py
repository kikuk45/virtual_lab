...
if st.button("Hitung & Tampilkan"):
    try:
        ...
        if not angka:
            st.error("❌ Tidak ada angka yang dimasukkan. Mohon masukkan setidaknya satu angka.")
        else:
        ...
        st.error("❌ Input tidak valid. Pastikan Anda hanya memasukkan angka yang dipisahkan dengan koma.")
    except ZeroDivisionError:
        # Menangani error jika input angka kosong setelah pemrosesan
        st.error("❌ Tidak ada angka yang valid yang dimasukkan untuk dihitung.")
